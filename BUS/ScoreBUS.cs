...
namespace DXApplication9.BUS
{
    ...
    {
        private static ScoreBUS instance;

        private ScoreBUS() { }

        public static ScoreBUS Instance
        {
            get
            {
                if (instance == null) instance = new ScoreBUS();
                return instance;
            }
            ...
            ref int[,] STT)
        {
            ...
            foreach (DataGridViewRow rowHocSinh in dataGridViewX.Rows)
            {
                ...
                DataTable dataTable = ScoreDAO.Instance.LayDanhSachDiem(
            ...
            string maLop)
        {
            ...
            DataTable dataTable = ScoreDAO.Instance.LayDanhSachDiem(maHocSinh, maMonHoc, maHocKy, maNamHoc, maLop);
        ...
        {
            DataTable dataTable = ScoreDAO.Instance.LayDanhSachDiemHocSinh(maHocSinh, maMonHoc, maHocKy, maNamHoc, maLop);
            float tongDiem = 0;
            int tongHeSo = 0;
        ...
        {
            DataTable dataTable = SubjectDAO.Instance.LayDanhSachMonHoc(maNamHoc, maLop);
        ...
        {
            ScoreDAO.Instance.ThemDiem(diem);
        }

        public void XoaDiem(int stt)
        {
            ScoreDAO.Instance.XoaDiem(stt);
        }
    }
}
