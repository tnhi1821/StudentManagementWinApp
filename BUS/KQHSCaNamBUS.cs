...
namespace DXApplication9.BUS
{
    public class KQHSCaNamBUS
    {
        ...
        public void LuuKetQua(string maHocSinh, string maLop, string maNamHoc)
        {
            ...
            float diemTBCNChung = ScoreBUS.Instance.LayDiemTBCNChung(maHocSinh, maLop, maNamHoc);
            ...
            KQHSCaNamDAO.Instance.LuuKetQua(new KQHSCaNamDTO(
                ...
                hanhKiem,
                ketQua,
                ScoreBUS.Instance.LayDiemTBHKChung(maHocSinh, maLop, maNamHoc, "HK1"),
                ScoreBUS.Instance.LayDiemTBHKChung(maHocSinh, maLop, maNamHoc, "HK2"),
                diemTBCNChung
            ));
        }
