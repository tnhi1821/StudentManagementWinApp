    ...
    public class KQHSMonHocBUS
    {
        ...
        public void LuuKetQua(string maHocSinh, string maLop, string maNamHoc, string maMonHoc, string maHocKy)
        {
            ...
            KQHSMonHocDAO.Instance.LuuKetQua(new KQHSMonHocDTO(
                ...
                monHoc,
                hocKy,
                ScoreBUS.Instance.LayDiemMiengTB(maHocSinh, maLop, maNamHoc, maMonHoc, maHocKy),
                ScoreBUS.Instance.LayDiem15PhutTB(maHocSinh, maLop, maNamHoc, maMonHoc, maHocKy),
                ScoreBUS.Instance.LayDiem45PhutTB(maHocSinh, maLop, maNamHoc, maMonHoc, maHocKy),
                ScoreBUS.Instance.LayDiemThi(maHocSinh, maLop, maNamHoc, maMonHoc, maHocKy),
                ScoreBUS.Instance.LayDiemTBHKTheoMon(maHocSinh, maLop, maNamHoc, maMonHoc, maHocKy)
            ));
        }
